...
public class HexBuffer implements Buffer{
	...
	public short getShort() {
		return fun.useless.xfer.util.Arrays.toShort(new byte[]{get(),get()}, Endianness.Big);
	}

	public Buffer putShort(short value) {
		return put(fun.useless.xfer.util.Arrays.fromShort(value, Endianness.Big));
	}

	public short getShort(int index) {
		return fun.useless.xfer.util.Arrays.toShort(new byte[]{get(index),get(index+1)}, Endianness.Big);
	}

	public Buffer putShort(int index, short value) {
		return put(index,fun.useless.xfer.util.Arrays.fromShort(value, Endianness.Big));
	}

	public int getInt() {
		return fun.useless.xfer.util.Arrays.toInt(new byte[]{get(),get(),get(),get()}, Endianness.Big);
	}

	public Buffer putInt(int value) {
		return put(fun.useless.xfer.util.Arrays.fromInt(value, Endianness.Big));
	}

	public int getInt(int index) {
		return fun.useless.xfer.util.Arrays.toInt(new byte[]{get(index),get(index+1),get(index+2),get(index+3)}, Endianness.Big);
	}

	public Buffer putInt(int index, int value) {
		return put(index,fun.useless.xfer.util.Arrays.fromInt(value, Endianness.Big));
	}

	public long getLong() {
		return fun.useless.xfer.util.Arrays.toLong(new byte[]{get(),get(),get(),get(),get(),get(),get(),get()}, Endianness.Big);
	}

	public Buffer putLong(long value) {
		return put(fun.useless.xfer.util.Arrays.fromLong(value, Endianness.Big));
	}

	public long getLong(int index) {
		return fun.useless.xfer.util.Arrays.toLong(new byte[]{get(index),get(index+1),get(index+2),get(index+3),get(index+4),get(index+5),get(index+6),get(index+7)}, Endianness.Big);
	}

	public Buffer putLong(int index, long value) {
		return put(index,fun.useless.xfer.util.Arrays.fromLong(value, Endianness.Big));
	}
