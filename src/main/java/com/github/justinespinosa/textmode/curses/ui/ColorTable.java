...
public class ColorTable<T extends Color> extends ArrayList<RGB>{
	...
	static{
		...
		tables.put(ColorDepth.COL16, AnsiColor16);
		tables.put(ColorDepth.COL256, XTermColor256);
		
	}


	public static ColorTable forDepth(ColorDepth depth){
		return tables.get(depth);
	}
